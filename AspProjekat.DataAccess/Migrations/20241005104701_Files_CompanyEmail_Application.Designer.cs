...
namespace AspProjekat.DataAccess.Migrations
{
    ...
    [Migration("20241005104701_Files_CompanyEmail_Application")]
    partial class Files_CompanyEmail_Application
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AspProjekat.Domain.Application", b =>
                {
            ...
            modelBuilder.Entity("AspProjekat.Domain.File", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AspProjekat.Domain.Application", b =>
                {
                    b.HasOne("AspProjekat.Domain.File", "File")
                        .WithMany()
            ...
            modelBuilder.Entity("AspProjekat.Domain.Company", b =>
                {
                    ...
                    b.HasOne("AspProjekat.Domain.User", "User")
                        .WithOne("Company")
                        .HasForeignKey("AspProjekat.Domain.Company", "UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
