...
namespace AspProjekat.Implementation.UseCases.Queries
{
    ...
    {
        public EfGetCompaniesQuery(AspContext context) : base(context)
        {
        }

        public int Id => 2;

        public string Name => "Search Companies";

        public PagedResponse<CompanyDto> Execute(CompanySearch search)
        {
